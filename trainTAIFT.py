    ...
    with torch.no_grad():
        for it, (images_vis, images_ir, name) in enumerate(test_loader):
            ...
            logits, binary_out = fusionmodel(images_vis_ycrcb,
                                             images_ir)
            saveTAIFTOutput(fused_dir, images_vis_ycrcb, logits, name)
    pass


def saveTAIFTOutput(fused_dir, images_vis_ycrcb, logits, name):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', '-M', type=str, default='TAIFT')
